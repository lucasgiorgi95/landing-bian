  ...
  return (
    <section className="relative bg-gradient-to-br from-[#f8f3d4] via-[#f0ebc0] to-[#f8f3d4] py-10 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 right-16 w-16 h-16 bg-[#00843d]/15 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-20 left-20 w-24 h-24 bg-[#00843d]/8 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-32 right-10 w-12 h-12 bg-[#00843d]/12 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
        <div className="absolute top-1/2 left-8 w-8 h-8 bg-[#00843d]/20 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute top-1/3 right-8 w-14 h-14 bg-[#00843d]/10 rounded-full animate-pulse" style={{animationDelay: '2.5s'}}></div>
        
        {/* Formas geométricas flotantes */}
        <div className="absolute top-16 left-1/4 w-6 h-6 bg-[#00843d]/15 rotate-45 animate-bounce" style={{animationDelay: '0.8s'}}></div>
        <div className="absolute bottom-24 right-1/4 w-8 h-8 bg-[#00843d]/12 rotate-12 animate-bounce" style={{animationDelay: '1.2s'}}></div>
        <div className="absolute top-1/4 right-1/3 w-4 h-4 bg-[#00843d]/18 rounded-full animate-bounce" style={{animationDelay: '1.8s'}}></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <div className="mb-12 relative">
          ...
          <div className="absolute inset-0 w-40 h-40 mx-auto">
            <div className="w-full h-full border-4 border-[#00843d]/20 rounded-full animate-spin" style={{animationDuration: '20s'}}></div>
          </div>
          
          {/* Anillo decorativo medio */}
          <div className="absolute inset-2 w-36 h-36 mx-auto">
            <div className="w-full h-full border-2 border-[#00843d]/30 rounded-full animate-spin" style={{animationDuration: '15s', animationDirection: 'reverse'}}></div>
          </div>
          ...
          <div className="relative w-32 h-32 bg-gradient-to-br from-[#00843d] to-[#006b32] rounded-full mx-auto mb-6 flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-500 hover:rotate-12">
            <span className="text-white font-bold text-4xl animate-pulse">👩‍🏫</span>
          </div>
          ...
          <div className="absolute -top-2 -right-6 text-xl animate-bounce" style={{animationDelay: '1s'}}>✏️</div>
        ...
        <div className="mb-12">
          <p className="text-xl md:text-2xl text-gray-700 mb-6 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="text-[#00843d] font-semibold">material didáctico atractivo</span>{' '}
            y funcional. Transformo ideas educativas en{' '}
            <span className="text-[#00843d] font-semibold">diseños visuales</span>{' '}
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="text-sm font-semibold text-gray-700">Diseños Creativos</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="text-2xl mb-1">📚</div>
              <div className="text-sm font-semibold text-gray-700">Material Didáctico</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="text-2xl mb-1">💡</div>
              <div className="text-sm font-semibold text-gray-700">Ideas Innovadoras</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="text-2xl mb-1">❤️</div>
              <div className="text-sm font-semibold text-gray-700">Con Amor</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 animate-bounce">
          ...
          <p className="text-[#00843d]/70 text-sm mt-2 font-medium">Explora mis trabajos</p>
        </div>
      </div>
    </section>
  );
